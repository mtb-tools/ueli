<template>
    <div>
        <FilePathSearchResultIcon v-if="isFilePathIcon" :icon="icon" />
        <DataUrlSearchResultIcon v-if="isDataUrlIcon" :icon="icon" />
    </div>
</template>
...
const { icon } = defineProps<{ icon: SearchResultItemIcon }>();
